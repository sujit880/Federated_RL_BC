...
##############################################
global_params, is_available = modman.fetch_params(URL, ALIAS)
...
if TEST_PARAMS.CERF > 0:
    ...
    P('\n\nValidated on', TEST_PARAMS.CERF, ' Episodes')
    P('Mean Reward:', np.mean(effs))
